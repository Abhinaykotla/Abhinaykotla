...
Welcome to my GitHub profile! I'm an experienced professional specializing in **AI/ML Engineering**, **IT Operations**, and **Full Stack Development**. Currently working at UT Arlington's Office of Information Technology. I focus on developing AI-powered automation solutions, NLP applications, and scalable web platforms.

---

## 🚀 About Me

- 💼 **IT Operations** @ UT Arlington Office of Information Technology
- 🎓 MSCS @ UT Arlington (GPA: 4.0/4.0)
- 🤖 Developing AI-powered chatbots using Python and NLP for campus IT support
- 📈 Improved ticket resolution time by 18% through automation and ML-based intent detection
- 🛠️ Expertise in **PyTorch**, **TensorFlow**, **Hugging Face**, **ServiceNow**, and **Automation**
- 🌐 Full-stack developer with experience in **React**, **Firebase**, **Node.js**, and **REST APIs**
- ☁️ Cloud & MLOps: Docker, Kubernetes, AWS, GCP, Azure, CI/CD pipelines
- 🔍 Built scalable AI solutions in image inpainting, text summarization, and model compression
- 🧑‍💻 5,000+ users supported with expertise in Linux, macOS, and Windows systems
